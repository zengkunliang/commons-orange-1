...
public enum BusinessMessageEnum {
    ...
    /** 折扣校验 公司编码数据不可为Bank **/
    MESSAGE_0203("business_message_0203", "0203", "折扣公司编码数据不可为Bank"),
    /** 折扣校验 公司编码数据不合规范 **/
    MESSAGE_0204("business_message_0204", "0204", "折扣公司编码数据不合规范"),
    /** 折扣校验 分组数据不可为null **/
    MESSAGE_0205("business_message_0205", "0205", "折扣分组数据不可为null"),
    /** 折扣校验 唯一标识数据不合规范 **/
    MESSAGE_0206("business_message_0206", "0206", "折扣唯一标识数据不合规范"),
    /** 折扣校验 名称数据不合规范 **/
    MESSAGE_0207("business_message_0207", "0207", "折扣名称数据不合规范"),
    /** 折扣校验 开始日期不可null **/
    MESSAGE_0208("business_message_0208", "0208", "折扣开始日期不可null"),
    /** 折扣校验 结束日期不可null **/
    MESSAGE_0209("business_message_0209", "0209", "折扣结束日期不可null"),
    /** 折扣校验 开始日期不得大于结束日期 **/
    MESSAGE_0210("business_message_0210", "0210", "折扣开始日期不得大于结束日期"),
    /** 折扣校验 结束日期不得小于当前日期 **/
    MESSAGE_0211("business_message_0211", "0211", "折扣结束日期不得小于当前日期"),
    /** 折扣校验 星期区间不可null **/
    MESSAGE_0212("business_message_0212", "0212", "折扣星期区间不可null"),
    /** 折扣校验 星期区间数据不合规范 **/
    MESSAGE_0213("business_message_0213", "0213", "折扣星期区间数据不合规范"),
    /** 折扣校验 时间区间未设置 **/
    MESSAGE_0214("business_message_0214", "0214", "折扣时间区间未设置"),
    ...
    MESSAGE_0403("business_message_0403", "0403", "折扣计算条件中计算商品数据不可为null"),
    /** 折扣计算条件验证 目标商品数据不可为null **/
    MESSAGE_0404("business_message_0404", "0404", "折扣计算条件中目标商品数据不可为null"),
    ...
    MESSAGE_0703("business_message_0703", "0703", "折扣参与条件参数顾客属性中分类表达式key数据不合规范"),
    /** 折扣参与条件参数顾客验证 分类表达式key对应的条码数据不可为null **/
    MESSAGE_0704("business_message_0704", "0704", "折扣参与条件参数顾客属性中分类表达式key对应的分类数据不可为null"),
    /** 折扣参与条件参数顾客验证 分类表达式key对应的分类数据不合规范 **/
    MESSAGE_0705("business_message_0705", "0705", "折扣参与条件参数顾客属性中分类表达式key对应的分类数据不合规范"),
    /** 折扣参与条件参数顾客验证 性别表达式key数据不合规范 **/
    MESSAGE_0706("business_message_0706", "0706", "折扣参与条件参数顾客属性中性别表达式key数据不合规范"),
    /** 折扣参与条件参数顾客验证 性别表达式key对应的条码数据不可为null **/
    MESSAGE_0707("business_message_0707", "0707", "折扣参与条件参数顾客属性中性别表达式key对应的性别数据不可为null"),
    /** 折扣参与条件参数顾客验证 性别表达式key对应的条码数据不可为null **/
    MESSAGE_0708("business_message_0708", "0708", "折扣参与条件参数顾客属性中生日表达式key对应的性别数据不合规范"),
    /** 折扣参与条件参数顾客验证 年龄表达式key数据不合规范 **/
    MESSAGE_0709("business_message_0709", "0709", "折扣参与条件参数顾客属性中年龄表达式key数据不合规范"),
    /** 折扣参与条件参数顾客验证 年龄表达式key对应的条码数据不可为null **/
    MESSAGE_0710("business_message_0710", "0710", "折扣参与条件参数顾客属性中年龄表达式key对应的年龄数据不可为null"),
    /** 折扣参与条件参数顾客验证 年龄表达式key对应的年龄数据不合规范 **/
    MESSAGE_0711("business_message_0711", "0711", "折扣参与条件参数顾客属性中年龄表达式key对应的年龄数据不合规范"),
    /** 折扣参与条件参数顾客验证 生日表达式key数据不合规范 **/
    MESSAGE_0712("business_message_0712", "0712", "折扣参与条件参数顾客属性中生日表达式key数据不合规范"),
    /** 折扣参与条件参数顾客验证 生日表达式key对应的条码数据不可为null **/
    MESSAGE_0713("business_message_0713", "0713", "折扣参与条件参数顾客属性中生日表达式key对应的生日数据不可为null"),
    /** 折扣参与条件参数顾客验证 生日表达式key对应的生日数据不合规范 **/
    MESSAGE_0714("business_message_0714", "0714", "折扣参与条件参数顾客属性中生日表达式key对应的生日数据不合规范"),
    ...
    MESSAGE_0803("business_message_0803", "0803", "折扣参与条件参数商品属性中条码表达式key数据不合规范"),
    /** 折扣参与条件参数商品验证 条码表达式key对应的条码数据不可为null **/
    MESSAGE_0804("business_message_0804", "0804", "折扣参与条件参数商品属性中条码表达式key对应的条码数据不可为null"),
    /** 折扣参与条件参数商品验证 条码表达式key对应的条码数据不合规范 **/
    MESSAGE_0805("business_message_0805", "0805", "折扣参与条件参数商品属性中条码表达式key对应的条码数据不合规范"),
    /** 折扣参与条件参数商品验证 最小金额表达式key数据不合规范 **/
    MESSAGE_0806("business_message_0806", "0806", "折扣参与条件参数商品属性中最小金额表达式key数据不合规范"),
    /** 折扣参与条件参数商品验证 最小金额表达式key对应的金额数据不可为null **/
    MESSAGE_0807("business_message_0807", "0807", "折扣参与条件参数商品属性中最小金额表达式key对应的金额数据不可为null"),
    /** 折扣参与条件参数商品验证 最小金额表达式key对应的金额数据不合规范 **/
    MESSAGE_0808("business_message_0808", "0808", "折扣参与条件参数商品属性中最小金额表达式key对应的金额数据不合规范"),
    /** 折扣参与条件参数商品验证 最大金额表达式key数据不合规范 **/
    MESSAGE_0809("business_message_0809", "0809", "折扣参与条件参数商品属性中最大金额表达式key数据不合规范"),
    /** 折扣参与条件参数商品验证 最大金额表达式key对应的金额数据不可为null **/
    MESSAGE_0810("business_message_0810", "0810", "折扣参与条件参数商品属性中最大金额表达式key对应的金额数据不可为null"),
    /** 折扣参与条件参数商品验证 最大金额表达式key对应的金额数据不合规范 **/
    MESSAGE_0811("business_message_0811", "0811", "折扣参与条件参数商品属性中最大金额表达式key对应的金额数据不合规范"),
    /** 折扣参与条件参数商品验证 最小金额不得大于最大金额 **/
    MESSAGE_0812("business_message_0812", "0812", "折扣参与条件参数商品属性中最小金额不得大于最大金额"),
    ...
    MESSAGE_0902("business_message_0902", "0902", "折扣参与条件交易参数当前交易属性中交易参与类型不可为null"),
    /** 折扣参与条件交易参数当前交易验证 交易参与类型数据不合规范 **/
    MESSAGE_0903("business_message_0903", "0903", "折扣参与条件交易参数当前交易属性中交易参与类型数据不合规范"),
    /** 折扣参与条件交易参数当前交易验证 交易总金额表达式key数据不合规范 **/
    MESSAGE_0904("business_message_0904", "0904", "折扣参与条件交易参数当前交易属性中交易总金额表达式key数据不合规范"),
    /** 折扣参与条件交易参数当前交易验证 交易总金额key对应的金额数据不可为null **/
    MESSAGE_0905("business_message_0905", "0905", "折扣参与条件交易参数当前交易属性中交易总金额key对应的金额数据不可为null"),
    /** 折扣参与条件交易参数当前交易验证 交易总金额表达式key对应的金额数据不合规范 **/
    MESSAGE_0906("business_message_0906", "0906", "折扣参与条件交易参数当前交易属性中交易总金额表达式key对应的金额数据不合规范"),

    /** 折扣参与条件交易参数关联交易验证 公司号表达式key数据不合规范 **/
    MESSAGE_1000("business_message_1000", "1000", "折扣参与条件交易参数关联交易属性中公司号表达式key数据不合规范"),
    /** 折扣参与条件交易参数关联交易验证 公司号表达式key对应的公司号数据不可为null **/
    MESSAGE_1001("business_message_1001", "1001", "折扣参与条件交易参数关联交易属性中公司号表达式key对应的公司号数据不可为null"),
    /** 折扣参与条件交易参数关联交易验证 公司号表达式key对应的公司号数据不合规范 **/
    MESSAGE_1002("business_message_1002", "1002", "折扣参与条件交易参数关联交易属性中公司号表达式key对应的公司号数据不合规范"),
    /** 折扣参与条件交易参数关联交易验证 交易开始时间表达式key数据不合规范 **/
    MESSAGE_1003("business_message_1003", "1003", "折扣参与条件交易参数关联交易属性中交易开始时间表达式key数据不合规范"),
    /** 折扣参与条件交易参数关联交易验证 交易开始时间表达式key对应的开始时间数据不可为Blank **/
    MESSAGE_1004("business_message_1004", "1004", "折扣参与条件交易参数关联交易属性中交易开始时间表达式key对应的开始时间数据不可为Blank"),
    /** 折扣参与条件交易参数关联交易验证 交易开始时间表达式key对应的开始时间数据不合规范 **/
    MESSAGE_1005("business_message_1005", "1005", "折扣参与条件交易参数关联交易属性中交易开始时间表达式key对应的开始时间数据不合规范"),
    /** 折扣参与条件交易参数关联交易验证 交易结束时间表达式key数据不合规范 **/
    MESSAGE_1006("business_message_1006", "1006", "折扣参与条件交易参数关联交易属性中交易结束时间表达式key数据不合规范"),
    /** 折扣参与条件交易参数关联交易验证 交易结束时间表达式key对应的结束时间数据不可为Blank **/
    MESSAGE_1007("business_message_1007", "1007", "折扣参与条件交易参数关联交易属性中交易结束时间表达式key对应的结束时间数据不可为Blank"),
    /** 折扣参与条件交易参数关联交易验证 交易结束时间表达式key对应的结束时间数据不合规范 **/
    MESSAGE_1008("business_message_1008", "1008", "折扣参与条件交易参数关联交易属性中交易结束时间表达式key对应的结束时间数据不合规范"),
    /** 折扣参与条件交易参数关联交易验证 交易开始时间不得大于交易结束时间 **/
    MESSAGE_1009("business_message_1009", "1009", "折扣参与条件交易参数关联交易属性中交易开始时间不得大于交易结束时间"),
    /** 折扣参与条件交易参数关联交易验证 交易总金额表达式key数据不合规范 **/
    MESSAGE_1010("business_message_1010", "1010", "折扣参与条件交易参数关联交易属性中交易总金额表达式key数据不合规范"),
    /** 折扣参与条件交易参数关联交易验证 交易总金额key对应的金额数据不可为null **/
    MESSAGE_1011("business_message_1011", "1011", "折扣参与条件交易参数关联交易属性中交易总金额key对应的金额数据不可为null"),
    /** 折扣参与条件交易参数关联交易验证 交易总金额表达式key对应的金额数据不合规范 **/
    MESSAGE_1012("business_message_1012", "1012", "折扣参与条件交易参数关联交易属性中交易总金额表达式key对应的金额数据不合规范"),
    ...
    /** 折扣计算条件参数最大值验证 公司最大折扣值表达式key数据不合规范 **/
    MESSAGE_1106("business_message_1106", "1106", "折扣计算条件参数最大值属性中公司最大折扣值表达式key数据不合规范"),
    /** 折扣计算条件参数最大值验证 公司最大折扣值表达式key对应的最大值数据不可为null **/
    MESSAGE_1107("business_message_1107", "1107", "折扣计算条件参数最大值属性中公司最大折扣值表达式key对应的最大值数据不可为null"),
    /** 折扣计算条件参数最大值验证 公司最大折扣值表达式key对应的最大值数据不合规范 **/
    MESSAGE_1108("business_message_1108", "1108", "折扣计算条件参数最大值属性中公司最大折扣值表达式key对应的最大值数据不合规范"),
    ...
    /** 折扣计算条件参数最大值验证 公司最大折扣值不得小于或等于0 **/
    MESSAGE_1111("business_message_1111", "1111", "折扣计算条件参数最大值属性中公司最大折扣值不得小于或等于0"),
    /** 折扣计算条件参数最大值验证 交易最大折扣值不得大于会员最大折扣最大值 **/
    MESSAGE_1112("business_message_1112", "1112", "折扣计算条件参数最大值属性中交易折扣最大值不得大于会员折扣最大值"),
    /** 折扣计算条件参数最大值验证 会员最大折扣值不得大于公司最大折扣最大值 **/
    MESSAGE_1113("business_message_1113", "1113", "折扣计算条件参数最大值属性中会员折扣最大值不得大于公司折扣最大值"),
    ...
    /** 当前交易校验 公司编码数据不可为Bank **/
    MESSAGE_1400("business_message_1400", "1400", "当前交易公司编码数据不可为Bank"),
    /** 当前交易校验 公司编码数据不合规范 **/
    MESSAGE_1401("business_message_1401", "1401", "当前交易公司编码数据不合规范"),
    ...
    /** 关联交易校验 公司编码数据不可为Bank **/
    MESSAGE_1500("business_message_1500", "1500", "关联交易公司编码数据不可为Bank"),
    /** 关联前交易校验 公司编码数据不合规范 **/
    MESSAGE_1501("business_message_1501", "1501", "关联交易公司编码数据不合规范"),
    /** 关联前交易校验 交易时间不可为null **/
